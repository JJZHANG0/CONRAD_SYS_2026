...
class InnovationBrief(models.Model):
    ...
    elevator_pitch = models.TextField(blank=True, default="")
    team_overview = models.TextField(blank=True, default="")
    opportunity = models.TextField(blank=True, default="")
    key_metrics = models.TextField(blank=True, default="")
    validation_progress = models.TextField(blank=True, default="")
    market = models.TextField(blank=True, default="")
    competition = models.TextField(blank=True, default="")
